!(function(e, t) {
            ...
            (n = a[t]),
              a !== (r = e[t]) &&
                (l && r && (b.isPlainObject(r) || (i = Array.isArray(r)))
                  ? (i ? ((i = !1), (o = n && Array.isArray(n) ? n : [])) : (o = n && b.isPlainObject(n) ? n : {}),
                    (a[t] = b.extend(l, o, r)))
                  : void 0 !== r && (a[t] = r));
      return a;
    }),
    ...
    if (((n = n || N), 'string' == typeof e)) {
      ...
      if (i[1]) {
        if (
          (b.merge(
            this,
            b.parseHTML(i[1], (t = t instanceof b ? t[0] : t) && t.nodeType ? t.ownerDocument || t : r, !0)
          ),
    ...
    b.each(
      {
        ...
        contents: function(e) {
          return D(e, 'iframe')
            ? e.contentDocument
            : (D(e, 'template') && (e = e.content || e), b.merge([], e.childNodes));
        }
      },
      function(e, t) {
        b.fn[e] = function(n, r) {
          ...
          return (
            ...
            this.length > 1 && (H[e] || b.uniqueSort(i), L.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
                      ...
                      if (!(t < o)) {
                        ...
                        g((l = e && ('object' == typeof e || 'function' == typeof e) && e.then))
                          ? i
                            ...
                            : l.call(e, a(++o, n, M, i), a(o, n, R, i), a(o, n, M, n.notifyWith))
                          : (r !== M && ((s = void 0), (u = [e])), (i || n.resolveWith)(s, u));
                      }
                    },
                    c = i
                      ? l
    ...
    b.extend({
      ...
      ready: function(e) {
        (!0 === e ? --b.readyWait : b.isReady) ||
          ((b.isReady = !0), (!0 !== e && --b.readyWait > 0) || $.resolveWith(r, [b]));
      }
    }),
    (b.ready.then = $.then),
    'complete' === r.readyState || ('loading' !== r.readyState && !r.documentElement.doScroll)
      ? e.setTimeout(b.ready)
      : (r.addEventListener('DOMContentLoaded', B), e.addEventListener('load', B));
  var F = function(e, t, n, r, i, o, a) {
      var s = 0,
        u = e.length,
        l = null == n;
      if ('object' === x(n)) for (s in ((i = !0), n)) F(e, t, s, n[s], !0, o, a);
      else if (
        void 0 !== r &&
        ((i = !0),
        g(r) || (a = !0),
      ...
      if (((r = 'data-' + t.replace(K, '-$&').toLowerCase()), 'string' == typeof (n = e.getAttribute(r)))) {
        try {
          n = (function(e) {
            return (
              'true' === e ||
              ('false' !== e && ('null' === e ? null : e === +e + '' ? +e : J.test(e) ? JSON.parse(e) : e))
            );
          })(n);
        } catch (e) {}
        Q.set(e, t, n);
  ...
  function oe(e, t, n, r) {
    ...
    if (c && c[3] !== l) {
      for (l = l || c[3], c = +(u /= 2) || 1; a--; )
        b.style(e, t, c + l), (1 - o) * (1 - (o = s() / u || 0.5)) <= 0 && (a = 0), (c /= o);
        ...
        if ('object' === x(o)) b.merge(p, o.nodeType ? [o] : o);
          ...
          for (
            a = a || f.appendChild(t.createElement('div')),
              ...
              a.innerHTML = (u = pe[s] || pe._default)[1] + b.htmlPrefilter(o) + u[2],
              c = u[0];
            c--;
      ...
      if (v)
        for (
          ...
          (d = g = (s = be.exec(t[l]) || [])[1]),
            ...
            d &&
              ((f = b.event.special[d] || {}),
              (f = b.event.special[(d = (i ? f.delegateType : f.bindType) || d)] || {}),
              (c = b.extend(
                {
                  type: d,
                  origType: g,
      ...
      if (v && (u = v.events)) {
        for (l = (t = (t || '').match(P) || ['']).length; l--; )
          if (((d = g = (s = be.exec(t[l]) || [])[1]), (h = (s[2] || '').split('.').sort()), d)) {
            ...
            a &&
              !p.length &&
              ((f.teardown && !1 !== f.teardown.call(e, h, v.handle)) || b.removeEvent(e, d, v.handle), delete u[d]);
        ...
        for (a = b.event.handlers.call(this, s, l), t = 0; (i = a[t++]) && !s.isPropagationStopped(); )
          for (s.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !s.isImmediatePropagationStopped(); )
            (s.rnamespace && !s.rnamespace.test(o.namespace)) ||
              ((s.handleObj = o),
              (s.data = o.data),
              void 0 !== (r = ((b.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u)) &&
                !1 === (s.result = r) &&
          ...
          if (1 === l.nodeType && ('click' !== e.type || !0 !== l.disabled)) {
            for (o = [], a = {}, n = 0; n < u; n++)
              void 0 === a[(i = (r = t[n]).selector + ' ')] &&
                (a[i] = r.needsContext ? b(i, this).index(l) > -1 : b.find(i, this, null, [l]).length),
                a[i] && o.push(r);
  ...
  function Oe(e, t, n, r) {
    ...
    if (
      p &&
      ((o = (i = ve(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = o), o || r)
    ) {
  ...
  b.extend({
    ...
    clone: function(e, t, n) {
      ...
      if (t)
        if (n) for (o = o || de(e), a = a || de(s), r = 0, i = o.length; r < i; r++) Le(o[r], a[r]);
        else Le(e, s);
  ...
  function We(e, t, n) {
    ...
    return (
      (n = n || Re(e)) &&
        ('' !== (a = n.getPropertyValue(t) || n[t]) || b.contains(e.ownerDocument, e) || (a = b.style(e, t)),
        !h.pixelBoxStyles() &&
          Me.test(a) &&
          Ie.test(t) &&
          ((r = s.width),
      ...
      'margin' === n && (u += b.css(e, n + ne[a], !0, i)),
        r
          ? ('content' === n && (u -= b.css(e, 'padding' + ne[a], !0, i)),
            'margin' !== n && (u -= b.css(e, 'border' + ne[a] + 'Width', !0, i)))
  ...
  function Qe(e, t, n) {
    ...
    return (
      ...
      ('auto' === i || (!parseFloat(i) && 'inline' === b.css(e, 'display', !1, r))) &&
    ...
    style: function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = Fe.test(t),
          l = e.style;
        if ((u || (t = Ve(s)), (a = b.cssHooks[t] || b.cssHooks[s]), void 0 === n))
      ...
      b.cssHooks[t] = {
        ...
        set: function(e, n, r) {
          ...
          return (
            ...
            s && (i = te.exec(n)) && 'px' !== (i[3] || 'px') && ((e.style[t] = n), (n = b.css(e, t))),
            Ge(0, n, s)
          );
        }
      };
  ...
  function nt() {
    Ze &&
      (!1 === r.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(nt) : e.setTimeout(nt, b.fx.interval),
      b.fx.tick());
  }
  function rt() {
    return (
  ...
  (b.Animation = b.extend(at, {
    ...
    tweener: function(e, t) {
      ...
      for (var n, r = 0, i = e.length; r < i; r++) (at.tweeners[(n = e[r])] = at.tweeners[n] || []).unshift(t);
    },
    prefilters: [
      function(e, t, n) {
        var r,
        ...
        if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(d))
          for (r in (f &&
            ...
            'none' === (c = b.css(e, 'display')) &&
              (l ? (c = l) : (ue([e], !0), (l = e.style.display || l), (c = b.css(e, 'display')), ue([e]))),
      ...
      return (
        b.fx.off
          ...
          : 'number' != typeof r.duration &&
            (r.duration = r.duration in b.fx.speeds ? b.fx.speeds[r.duration] : b.fx.speeds._default),
    ...
    (b.fn.delay = function(t, n) {
      return (
        ...
        this.queue((n = n || 'fx'), function(n, r) {
      ...
      attr: function(e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ? b.prop(e, t, n)
            : ((1 === o && b.isXMLDoc(e)) ||
                (i = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? st : void 0)),
              void 0 !== n
                ? null === n
  ...
  b.fn.extend({
    ...
    b.extend({
      prop: function(e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && b.isXMLDoc(e)) || (i = b.propHooks[(t = b.propFix[t] || t)]),
            void 0 !== n
              ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
          ...
          : this.each(function() {
              ...
              if (r)
                ...
                (void 0 !== e && 'boolean' !== n) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute('class', t || !1 === e ? '' : Y.get(this, '__className__') || ''));
            });
      },
      hasClass: function(e) {
        var t,
  ...
  b.extend(b.event, {
    trigger: function(t, n, i, o) {
      ...
      if (
        ...
        if (!o && !d.noBubble && !v(i)) {
          for (gt.test((l = d.delegateType || m) + m) || (s = s.parentNode); s; s = s.parentNode) y.push(s), (u = s);
  ...
  (Ot.href = yt.href),
    b.extend({
      ...
      ajax: function(t, n) {
        ...
        if (
          (y.promise(E),
          (h.url = ((t || h.url || yt.href) + '').replace(Nt, yt.protocol + '//')),
          ...
          try {
            (l.href = h.url),
              (l.href = l.href),
              (h.crossDomain = Ot.protocol + '//' + Ot.host != l.protocol + '//' + l.host);
          } catch (e) {
            h.crossDomain = !0;
          }
        }
        ...
        h.hasContent
          ...
          : ((d = h.url.slice(o.length)),
            ...
            !1 === h.cache && ((o = o.replace(Dt, '$1')), (d = (xt.test(o) ? '&' : '?') + '_=' + mt++ + d)),
            (h.url = o + d)),
        h.ifModified &&
          (b.lastModified[o] && E.setRequestHeader('If-Modified-Since', b.lastModified[o]),
        ...
        function k(t, n, r, s) {
          ...
          c ||
            ...
            l
              ? (h.ifModified &&
                  ((T = E.getResponseHeader('Last-Modified')) && (b.lastModified[o] = T),
    ...
    b.each(['get', 'post'], function(e, t) {
      b[t] = function(e, n, r, i) {
        return (
          ...
          b.ajax(b.extend({ url: e, type: t, dataType: i, data: n, success: r }, b.isPlainObject(e) && e))
        );
      };
    }),
      ...
      if (s || 'jsonp' === t.dataTypes[0])
        return (
          ...
          s
            ...
            : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? '&' : '?') + t.jsonp + '=' + i),
    ...
    (b.parseHTML = function(e, t, n) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          ...
          (o = A.exec(e))
            ? [t.createElement(o[1])]
            : ((o = ve([e], t, a)), a && a.length && b(a).remove(), b.merge([], o.childNodes)));
      var i, o, a;
    }),
